<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NhapSoTien.aspx.cs" Inherits="RutTien_Default" %>
...
<body>
    ...
    <div id="container">
		...
		<div class="main-content">
            ...
            <center>
                <asp:TextBox ID="txtTien" TextMode="Number" CssClass="txt-single" runat="server"></asp:TextBox>

            </center>
			<div class="select-single" style="    top: -25px;">
